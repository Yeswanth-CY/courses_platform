-- Create a stored procedure to set up the users table
...
BEGIN
  ...
  INSERT INTO users (name, avatar_color)
  SELECT name, color
  FROM (
    VALUES 
      ('Yeswanth', '#8B5CF6'),
  ...
  -- Create function to update user stats if it doesn't exist
